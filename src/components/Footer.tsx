  ...
  return (
    <footer className="w-full bg-blue-900 p-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 space-y-8">
        ...
        <div className=" space-y-2 flex flex-col text-white  items-end lg:items-start">
          <h1 className=" text-white font-bold">Skytix</h1>
          <ul className="flex flex-col space-y-2 items-end lg:items-start">
            <li>
              <Link href={""}>
        ...
        {/* section 3 */}
        <div className="text-white flex flex-col space-y-2 w-10/12">
        <h1 className="text-xl font-bold " >
          Stay in The Loop
        </h1>
        <p className="text-xs font-thin">join our mailing list to stay in the loop for Event and Concert</p>

        {/* email */}
        <div className="flex bg-white p-2 rounded-full" >
        <input type="text" className="flex-1"/>
        <button className="w-40 lg:w-72 h-8 rounded-full bg-[#F5167E] text-xs">
          Subscribe Now
        </button>
        </div>
        </div>
